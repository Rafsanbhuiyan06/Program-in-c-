...
int main()
{
    student rafsan, rakib;

    rafsan.SetVlaue(10,3.4);
    rafsan.display();
...
public:
    void solve()
    {
        ...
        int m = in.readInt();
        int k = in.readInt();
        auto male = in.readIntArray(n);
        auto fem = in.readIntArray(m);
